...
pub fn run_stateful_precompile<CTX: ContextTr>(
            ...
            .is_empty()
    {
        context.journal_mut().set_code(
            to,
            // revm-41 migration: Bytecode::new_legacy replaces the original LegacyRawBytecode::into_analyzed and Bytecode::LegacyAnalyzed variant.
            Bytecode::new_legacy(bytes!("0x01")),
        )
    }
